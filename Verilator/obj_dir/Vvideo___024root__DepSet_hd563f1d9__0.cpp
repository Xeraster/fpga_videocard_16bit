...
void Vvideo___024root___eval_triggers__ico(Vvideo___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vvideo___024root___eval_triggers__ico\n"); );
...
void Vvideo___024root___eval_triggers__act(Vvideo___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VactTriggered.set(0U, ((~ (IData)(vlSelfRef.HSYNC)) 
                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__HSYNC__0)));
    vlSelfRef.__VactTriggered.set(1U, ((IData)(vlSelfRef.pllclk) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__pllclk__0))));
    vlSelfRef.__VactTriggered.set(2U, ((~ (IData)(vlSelfRef.RESET)) 
                                       & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__RESET__0)));
    vlSelfRef.__VactTriggered.set(3U, ((IData)(vlSelfRef.pixelClock) 
